...
The [built-in browser `<option>` component](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/option) enables you render an option inside a [`<select>`](/reference/react-dom/components/select) box.
